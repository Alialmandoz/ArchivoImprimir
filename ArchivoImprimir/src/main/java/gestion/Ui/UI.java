...
public class UI {
	...
	private void initialize() {
		...
		JScrollPane scrollBorrar = new JScrollPane();
		scrollBorrar.setBounds(10, 120, 320, 555);
		scrollBorrar.getViewport().setView(modelo.crearTabla());
		borrarCliente.add(scrollBorrar);

		tabbedPane.addChangeListener(new ChangeListener() {

			@Override
			public void stateChanged(ChangeEvent e) {
				if (tabbedPane.getSelectedIndex() == 1) // Index starts at 0, so
														// Index 2 = Tab3
				{
		...
		panel_1.setBounds(10, 11, 320, 100);
		...
		btnBuscarBorrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				scrollBorrar.getViewport()
							.setView(modelo.crearTablaBuscados(txtNomBorrar.getText(),txtApellBorrar.getText()));
			}
		});
		btnBuscarBorrar.setBounds(10, 67, 89, 23);
		panel_1.add(btnBuscarBorrar);

		JButton btnActualizarBorrar = new JButton("Actualizar");
		btnActualizarBorrar.addActionListener(new ActionListener() {
			@Override
		...
		btnActualizarBorrar.setBounds(109, 67, 103, 23);
		panel_1.add(btnActualizarBorrar);
		...
		btnBorrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				cli.deleteCliente(txtNomBorrar.getText(), txtApellBorrar.getText());
				scrollBorrar.getViewport().setView(modelo.crearTabla());
				vaciarCampo(txtNomBorrar);
				vaciarCampo(txtApellBorrar);
			}
		...
		JScrollPane scrollCargar = new JScrollPane();
		...
		tabbedPane.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
														...
														// Index 2 = Tab3
				{
					...
					scrollCargar.setBounds(10, 200, 320, 300);
					scrollCargar.getViewport().setView(modelo.crearTabla());
					cargaCliente.add(scrollCargar);
				}
		...
		button_1.setBounds(162, 138, 90, 23);
		panel.add(button_1);
	}
